...
from tensorflow.python.keras.layers import Activation, MaxPooling2D, UpSampling2D, Dense, BatchNormalization, Input, Reshape, multiply, \
    add, Dropout, AveragePooling2D, GlobalAveragePooling2D, concatenate, Conv2D, Conv2DTranspose
...
def define_tiramisu(inputs, n_classes=1, n_filters_first_conv=48, n_pool=5, growth_rate=16,
             n_layers_per_block=[4, 5, 7, 10, 12, 15, 12, 10, 7, 5, 4], dropout_p=0.2):
